$dbd_oracle_mm_opts = {
                        ...
                        'INC' => '-I/media/share/Documentation/cfalcas/q/import_docs/instantclient_11_2/sdk/include -I/usr/lib64/perl5/vendor_perl/auto/DBI',
                        'LIBS' => [
                                    '-L/media/share/Documentation/cfalcas/q/import_docs/instantclient_11_2 -lclntsh'
                                  ],
                        'AUTHOR' => 'Tim Bunce (dbi-users@perl.org)',
                        'DIR' => [],
                        'DEFINE' => ' -Wall -Wno-comment -DUTF8_SUPPORT -DORA_OCI_VERSION=\\"11.2\\" -DORA_OCI_102 -DORA_OCI_112',
                        'dynamic_lib' => {
                                           'OTHERLDFLAGS' => ''
                                         },
                        'dist' => {
...
',
                                             ...
                                             '#     BUILD_REQUIRES => {  }',
                                             '#     CONFIGURE_REQUIRES => {  }',
                                             '#     DEFINE => q[ -Wall -Wno-comment -DUTF8_SUPPORT -DORA_OCI_VERSION=\\"11.2\\" -DORA_OCI_102 -DORA_OCI_112]',
                                             '#     DIR => []',
                                             '#     INC => q[-I/media/share/Documentation/cfalcas/q/import_docs/instantclient_11_2/sdk/include -I/usr/lib64/perl5/vendor_perl/auto/DBI]',

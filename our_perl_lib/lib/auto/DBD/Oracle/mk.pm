$dbd_oracle_mm_opts = {
                        ...
                        'DIR' => [],
                        'DEFINE' => ' -Wall -Wno-comment -DUTF8_SUPPORT -DORA_OCI_VERSION=\\"11.2.0\\" -DORA_OCI_102 -DORA_OCI_112',
                        'dynamic_lib' => {
                                           'OTHERLDFLAGS' => ''
                                         },
                        'dist' => {
...
',
                                             ...
                                             '#     BUILD_REQUIRES => {  }',
                                             '#     CONFIGURE_REQUIRES => {  }',
                                             '#     DEFINE => q[ -Wall -Wno-comment -DUTF8_SUPPORT -DORA_OCI_VERSION=\\"11.2.0\\" -DORA_OCI_102 -DORA_OCI_112]',
                                             '#     DIR => []',
